...
export type ActiveView = "invoice-prep" | "customers" | "fortnox" | "review-queue";
...
export function hydrateState(parsed: PersistedState): AppState {
  ...
  return {
      ...initialState,
      ...parsed,
      activeView: ["customers", "fortnox", "review-queue"].includes(parsed.activeView || "") ? parsed.activeView as ActiveView : "invoice-prep",
      customers,
      ...
      customerJobs: Array.isArray(parsed.customerJobs) ? parsed.customerJobs : Array.isArray(parsed.jobs) ? parsed.jobs : [],
